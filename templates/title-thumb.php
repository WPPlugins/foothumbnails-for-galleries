<style>
	.ftg-titlethumb.ftg-<?php echo $ftg_id; ?> {<?php echo $ftg_wrap; ?> max-width: <?php echo $ftgwidth[1];?>px; cursor: pointer; display: block; margin: 1em 0;}
	<?php echo strip_tags($ftg_css); ?>
</style>

<div class="ftg-titlethumb ftg-<?php echo $ftg_id; ?>">
