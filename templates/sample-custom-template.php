...
// $ftgwidth outputs the width of the selected thumbnail image in pixels
...
// 3. The Div Click and Hidden Div Sections, where the Gallery is output.
//
...
.ftg-fullhor.ftg-<?php echo $ftg_id; ?> {<?php echo $ftg_wrap; ?> cursor: pointer; }
<?php 
...
<h2><?php echo $ftg_title ; ?></h2>
	<div class="ftg-content">
		<!-- In order for FooBox to be trigger from your thumbnail image, it needs to be wrapped like this and have the class "foobox ftgtrigger". -->
...
// If you want to include the "div click" javascript and the hidden div just as they are, simply use these includes:

//	include ( FTG_PATH . 'templates/div-click.php');
//	include ( FTG_PATH . 'templates/hidden-div.php');

// Truthfully, there's no reason to change these, but if you REALLY want to customize them below is the full markup which you can customize.
?>

<!-- Start of div click javascript -->
<script>
