<style>
.ftg-fullvertimgtop.ftg-<?php echo $ftg_id; ?> {<?php echo $ftg_wrap; ?> max-width: <?php echo $ftgwidth[1];?>px; cursor: pointer;}
<?php echo strip_tags($ftg_css); ?>
</style>

<div class="ftg-fullvertimgtop ftg-<?php echo $ftg_id; ?>">
