=== FooThumbnail Gallery ===
Contributors: webdevmattcrom, fooplugins
Donate link: http://foothumbnails.mattcromwell.com/
Tags: thumbnail, lightbox,media,images,gallery
...
== Short Description ==
An easy way to display your WordPress galleries from a thumbnail image with FooBox.

**NOTE:** FooBox [Free](http://wordpress.org/plugins/foobox-image-lightbox/) or [Pro](http://fooplugins.com/plugins/foobox/?utm_source=foothumbnail&utm_medium=wprepo&utm_campaign=foothumbnail) is REQUIRED for this plugin to work.
...
**FULL DETAILS:** For more information and resources on FooThumbnails for Galleries, visit [foothumbnails.mattcromwell.com](http://foothumbnails.mattcromwell.com).
...
* Search for 'FooThumbnails'
* Activate FooThumbnails from your Plugins page.

= From WordPress.org =
* Search the Plugin Repository for FooThumbnails
* Download the .zip file.
* Go to your WordPress installation and go to "Plugins > Add New".
* Choose "Upload".
* Once you get the upload successful message, click "Activate"
* Now you should see a new menu item called "FooThumbnails". Go there and click "Add New" to create your first FooThumbnail.

== Frequently Asked Questions ==
1. **Where's the Options?**
...
3. **Can I change the styles of the gallery?** 
...
4. **The Template doesn't seem to work well with my theme. What do I do?**
...
5. **It's not loading in FooBox. What do I do?**
...
= Known Issues =
1. ** Jetpack Carousel **
Jetpack's Carousel takes over how the default WordPress gallery works throughout your whole site. Because FooThumbnails for Galleries depends on the default WordPress gallery, Jetpack's Carousel breaks FTG. This is a known issue for which there just is no resolution. If you want to use FTG and use a carousel gallery, I would suggest you look into [FooGallery](http://wordpress.org/plugins/foogallery) and perhaps [contact me](http://mattcromwell.com/foogallery-templates) about creating a custom gallery.

== Screenshots ==

1. Frontend example
2. Guided "Wizard" walks you through Step by Step
3. Thumbnail Image Sizes generated from the sizes supported by your theme
4. Text Wrapping
5. 6 static layouts with customization option
6. Your own Custom layout
7. Copy your shortcode straight from the Admin panel
