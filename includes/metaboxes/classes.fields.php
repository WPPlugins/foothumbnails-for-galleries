...
abstract class CMB_Field {
	...
	public function __construct( $name, $ftg_title, array $values, $args = array() ) {

		$this->id 		= $name;
		$this->name		= $name . '[]';
		$this->title 	= $ftg_title;
	...
	public function description() {
		...
		if ( $this->description ) { ?>
			...
			<div class="cmbftg_metabox_description"><?php echo wp_kses_post( $this->description ); ?></div>
...
class CMB_Text_Small_Field extends CMB_Text_Field {
	...
	public function html() {
		...
		$this->args['class'] .= ' cmbftg_text_small';
...
add_action( 'wp_ajax_cmbftg_request_image', array( 'CMB_Image_Field', 'request_image_ajax_callback' ) );
...
class CMB_URL_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input type="text" <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_url code' ); ?> <?php $this->name_attr(); ?> value="<?php echo esc_attr( esc_url( $this->value ) ); ?>" />
...
class CMB_Date_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_small cmbftg_datepicker' ); ?> type="text" <?php $this->name_attr(); ?> value="<?php echo esc_attr( $this->value ); ?>" />
...
class CMB_Time_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_small cmbftg_timepicker' ); ?> type="text" <?php $this->name_attr(); ?> value="<?php echo esc_attr( $this->value ); ?>"/>
...
class CMB_Date_Timestamp_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_small cmbftg_datepicker' ); ?> type="text" <?php $this->name_attr(); ?>  value="<?php echo $this->value ? esc_attr( date( 'm\/d\/Y', $this->value ) ) : '' ?>" />
...
class CMB_Datetime_Timestamp_Field extends CMB_Field {
	...
	public function html() { ?>
		...
		<input <?php $this->id_attr('date'); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_small cmbftg_datepicker' ); ?> type="text" <?php $this->name_attr( '[date]' ); ?>  value="<?php echo $this->value ? esc_attr( date( 'm\/d\/Y', $this->value ) ) : '' ?>" />
		<input <?php $this->id_attr('time'); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_text_small cmbftg_timepicker' ); ?> type="text" <?php $this->name_attr( '[time]' ); ?> value="<?php echo $this->value ? esc_attr( date( 'h:i A', $this->value ) ) : '' ?>" />
...
class CMB_Color_Picker extends CMB_Field {
	...
	public function html() { ?>
		...
		<input <?php $this->id_attr(); ?> <?php $this->boolean_attr(); ?> <?php $this->class_attr( 'cmbftg_colorpicker cmbftg_text_small' ); ?> type="text" <?php $this->name_attr(); ?> value="<?php echo esc_attr( $this->get_value() ); ?>" />
...
class CMB_wysiwyg extends CMB_Field {
	...
	public function html() {
		...
		if ( $this->is_placeholder() ) 	{
			...
			<script>
				if ( 'undefined' === typeof( cmbftg_wysiwyg_editors ) )
					var cmbftg_wysiwyg_editors = {};
				cmbftg_wysiwyg_editors.<?php echo $field_id; ?> = '<?php echo $editor; ?>';
			</script>
	...
	public function output_script() {
		...
		<script type="text/javascript">
			...
			(function($) {
				...
				if ( 'undefined' === typeof( window.cmbftg_select_fields ) )
					window.cmbftg_select_fields = {};

				var id = <?php echo json_encode( $this->get_js_id() ); ?>;
				window.cmbftg_select_fields[id] = options;
	...
	public function output_script() {
		...
		<script type="text/javascript">
			...
			(function($) {
				...
				var id = <?php echo json_encode( $this->get_js_id() ); ?>;
				var options = window.cmbftg_select_fields[id];
				...
				<?php if ( $this->args['ajax_url'] ) : ?>
					...
					var ajaxData = {
						action  : 'cmbftg_post_select',
						post_id : '<?php echo intval( get_the_id() ); ?>', // Used for user capabilty check.
						nonce   : <?php echo json_encode( wp_create_nonce( 'cmbftg_select_field' ) ); ?>,
...
function cmbftg_ajax_post_select() {
	...
	if ( ! $nonce || ! wp_verify_nonce( $nonce, 'cmbftg_select_field' ) || ! current_user_can( 'edit_post', $post_id ) ) {
...
add_action( 'wp_ajax_cmbftg_post_select', 'cmbftg_ajax_post_select' );
...
class CMB_Group_Field extends CMB_Field {
	...
	function __construct() {
		...
		if ( ! empty( $this->args['fields'] ) ) {
			foreach ( $this->args['fields'] as $f ) {
				...
				$class = _cmbftg_field_class_for_type( $f['type'] );
				$f['show_label'] = true;
	...
	public function html() {
		...
		<?php CMB_Meta_Box_FTG::layout_fields( $fields ); ?>
