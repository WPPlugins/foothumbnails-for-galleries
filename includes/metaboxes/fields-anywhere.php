 ...
 * @return null
 */
function cmbftg_draw_meta_boxes( $pages, $context = 'normal', $object = null ) {

	cmbftg_do_meta_boxes( $pages, $context, $object );
 ...
 */
function cmbftg_do_meta_boxes( $screen, $context, $object ) {
