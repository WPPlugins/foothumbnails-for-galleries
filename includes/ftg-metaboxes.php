...
add_filter( 'cmbftg_meta_boxes' , 'ftg_metaboxes' );
...
add_filter( 'cmbftg_field_types', function( $cmbftg_field_types ) {
	$cmbftg_field_types['step1-note'] = 'FTG_Step1Note';
	$cmbftg_field_types['step2-note'] = 'FTG_Step2Note';
	$cmbftg_field_types['step3-note'] = 'FTG_Step3Note';
	$cmbftg_field_types['image-sizes'] = 'FTG_Step3ImageSizes';
	$cmbftg_field_types['step4-note'] = 'FTG_Step4Note';
	$cmbftg_field_types['step5-note'] = 'FTG_Step5Note';
	$cmbftg_field_types['step5-alert'] = 'FTG_Step5Alert';
	$cmbftg_field_types['generate-css'] = 'FTG_GenerateCSS';
	$cmbftg_field_types['ftg-shortcode'] = 'FTG_ShowShortcode';

    return $cmbftg_field_types;
} );
